...
```html_example
 <div class="lud-form-element">
 <span class="lud-form-element__label" id="file-selector-id">Attachment</span>
 <div class="lud-form-element__control">
 <div class="lud-file-selector lud-file-selector--files">
 <div class="lud-file-selector__dropzone">
 <input class="lud-file-selector__input lud-assistive-text" accept="image/png" type="file" id="file-upload-input-01" aria-describedby="file-selector-id" />
 <label class="lud-file-selector__body" for="file-upload-input-01">
 <span class="lud-file-selector__button lud-button lud-button--neutral">
 <lud-icon type="upload" class="lud-button__icon lud-button__icon--left"></lud-icon>
 Upload Files</span>
 <!-- <span class="lud-file-selector__text lud-medium-show">or Drop Files</span> -->
 </label>
 </div>
 </div>
 </div>
